...
public class Cobranza implements Comparable<Cobranza> {
    ...
    public static class NameDomainEvent extends PropertyDomainEvent<Cobranza,String> {}
    ...
    public static class DeleteDomainEvent extends ActionDomainEvent<Cobranza> {}
    @Action(
    ...
    @Override
    public int compareTo(final Cobranza other) {
